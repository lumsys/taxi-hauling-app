...
<!-- <div class="row">
 ...
 <div class="element-wrapper">
                                    ...
                                    @foreach($drivers as $driver)
                                                    <tr>
                                                        <td>
                                                            <div class="user-with-avatar"><span class="d-none d-xl-inline-block smaller lighter">{{$driver['name']}}</span></div>
                                                        </td>
                                                       
                                                        <td class="text-center"><span class="smaller lighter">{{$driver['phone']}}</span></td>
                                                         <td class="text-center"><span class="smaller lighter">{{$driver['region']}}</span></td>
                                                        <td class="text-center"><span class="smaller lighter">{{$driver['tripCount']}}</span></td>
                                                        <td class="text-center"><span class="smaller lighter">  {{ number_format($driver['tripAmt'],2) }}</span></td>
                                                        <td class="text-center"><span class="smaller lighter"> {{$driver['tripDayCount'] }}</span></td>
                                                        <td class="text-center"><span class="smaller lighter"> {{number_format($driver['tripAmtDay'],2)}}</span></td>
                                                         <td class="text-center"><span class="smaller lighter"> {{$driver['tripAmtLastWeekCount']}}</span></td>
                                                         <td class="text-center"><span class="smaller lighter"> {{  number_format($driver['tripAmtLastWeek'],2)}}</span></td>
