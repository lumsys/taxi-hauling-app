                    ...
                    @endif
                            ...
                            @foreach($driverrequests as $driverrequest)
                                                    <tr>
                                                        ...
                                                        <td class="text-center smaller"><a class="mr-2 mb-2 btn btn-primary btn-sm" href="{{route('branch.approvedriverrequest',$driverrequest->id )}}">Approve</a></td>
                                                    
                                                    <td class="text-center smaller"><a class=" mb-2 btn btn-danger btn-sm" href="{{route('branch.declinedriverrequest',$driverrequest->id )}}" onclick="return confirm('Are you sure you want to do this?');">Decline</a></td>
