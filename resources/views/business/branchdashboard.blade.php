...
<div class="element-wrapper">
  ...
  <div class="row">
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Dashboard for {{$user->name}}</h6>
                                    <div class="element-content">
                                       ...
                                       <!--     <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-4">
                                                <a class="element-box el-tablo" href="#">
                                                    <div class="label"><b>Trips Summary</b></div>
                                                    <div class="label"><b>Total:N{{number_format($totaltripAmt,2)}}</b></div>
                                                    <div class="label"><b>This Year:N{{number_format($totaltripAmtYear,2)}}</b></div>
                                                     <div class="label"><b>This Month:N{{number_format($totaltripAmtMonth,2)}}</b></div>
                                                     <div class="label"><b>Prev Month:N{{number_format($totaltripAmtMonthPrev,2)}}</b></div>
                                                     <div class="label"><b>Today:N{{number_format($totaltripAmtDay,2)}}</b></div>
                                                    <div class="trending trending-up-basic"><span></span></div>
                                                </a>
                                            </div>
                                        </div>
						  ...
						  <div class="row">
                            <div class="col-sm-6">
                                 <a class="btn btn-sm btn-success" href="{{route('business.businessbranchtrips',$user->unique_code)}}" target="_blank">view Trips</a>
                                 <a class="btn btn-sm btn-success" href="{{route('business.getbranchstaff',$user->unique_code)}}" target="_blank">view Staffs</a>
                            </div>
                             <div class="col-sm-6">
