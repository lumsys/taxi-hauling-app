...
<div class="row">
                ...
                <div class="col-md-4">
                     <form action="{{route('business.searchbranchtrip',$business_code)}}" method="POST" enctype="multipart/form-data" >
                                    {{ csrf_field() }}
                ...
                <div class="col-md-4">
                     <div class="form-group" align="center">
                       ...
                       <a href="{{route('business.businessbranchtrips',$business_code)}}" class="btn btn-default">Reset</a>   
                    </div>
                </div>
