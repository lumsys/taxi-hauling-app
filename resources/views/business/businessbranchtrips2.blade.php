...
<div> 
    <a href="{{route('business.exporttrips', 'xlsx')}}" class="btn btn-success">Export to .xlsx</a>
     <a href="{{route('business.exporttrips', 'xls')}}" class="btn btn-success">Export to .xls</a>
                                                        ...
                                                        <td class="text-center"><span class="larger darker"> {{\Carbon\Carbon::parse($trip->tripEndTime)}}</span></td>
                                                         ...
                                                         <td class="text-center"><span class="larger darker"> {{gmdate("H:i:s",$trip->wait_time)}}</span></td>
                                                          <td class="text-center"><span class="larger darker">{{ $trip->cost_wait }}</span></td>
                                                           <td class="text-center"><span class="larger darker">{{$trip->driver['name']}}</td>
                                                            <td class="text-center"><span class="larger darker">{{$trip->branch['name']}}</td>
                                                </tr> 
                                    @endforeach   
