                                ...
                                <div class="element-wrapper">
                                    ...
                                    <div class="element-content">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <a class="element-box el-tablo" href="#">
                                                    <div class="label">Branch Total Trips</div>
                                                    <div class="value">{{$totaltripbranch}}</div>
                                                    <div class="trending trending-up-basic"><span></span><!--<i class="os-icon os-icon-arrow-up2"></i> --></div>
                                                </a>
                                            </div>
                                          <div class="col-sm-4">
                                                <a class="element-box el-tablo" href="#">
                                                    <div class="label">Branch Today</div>
                                                    <div class="value">N{{number_format($totaltripbranchday,2) }}</div>
                                                    <div class="trending trending-up-basic"><span></span> </div>
                                                </a>
                                            </div>
                                             <div class="col-sm-4">
                                                <a class="element-box el-tablo" href="#">
                                                    <div class="label">Branch This Month</div>
                                                    <div class="value">N{{number_format($totaltripbranchmonth,2)}}</div>
                                                    <div class="trending trending-up-basic"><span></span> </div>
                                                </a>
                                            </div> 
