...
-------------------->
           <div class="menu-mobile menu-activated-on-click color-scheme-dark">
                <div class="mm-logo-buttons-w">
                    <a class="mm-logo" href="{{route('business.index')}}"><img src="https://smoothride.ng/wp-content/uploads/2019/03/Smoothride1.png"><span>SmoothRide</span></a>
                ...
                <!--     <div class="logged-user-menu color-style-bright">
                                    <div class="logged-user-avatar-info">
                                        <div class="avatar-w"><img alt="" src="img/avatar.jpg"></div>
                                    ...
                                    <ul>
                                         <li><a href="{{route('business.profile')}}"><i class="os-icon os-icon-user-male-circle2"></i><i class="os-icon os-icon-yen-bag"></i><span>Profile</span></a></li>
...
------------------->
                    ...
                    <li class="has-sub-menu"><span>Business Account</span></li>
                        <li class="selected">
                         ...
                         <li class="selected">
                            <a href="{{route('business.getstaff')}}">
                            <div class="icon-w">
                         ...
                         <li class="selected">
                            <a href="{{route('trip.alltrips')}}">
                            <div class="icon-w">
                                <div class="os-icon os-icon-coins-4"></div>
                            </div><span>Trips Request</span></a>
                            
                        </li>
                         <li class="selected">
                            <a href="{{route('business.getbranchdriverrequest')}}">
                            <div class="icon-w">
                                <div class="os-icon-grid-circles"></div>
                            </div><span>Drivers Request</span></a>
                    ...
                    @endif
                     ...
                     <li class="sub-header"><span>Business Account</span></li>
                    <li class="selected">
                        <a href="{{route('business.index')}}">
                            <div class="icon-w">
                    ...
                    <li class="selected ">
                        <a href="{{route('branch.getstaff')}}">
                            <div class="icon-w">
                                <div class="picons-thin-icon-thin-0719_group_users_circle"></div>
                            </div><span>Staff</span></a>
                    </li>
                    <li class="selected ">
                        <a href="{{route('branch.branchtrips')}}">
                            <div class="icon-w">
                                <div class="picons-thin-icon-thin-0545_map_travel_distance_directions"></div>
                            </div><span>Trips</span></a>
                    </li>
                    <li class="selected ">
                        <a href="{{route('branch.branchtriprequest')}}">
                            <div class="icon-w">
                                <div class="os-icon os-icon-coins-4"></div>
                            </div><span>Trips Request</span></a>
                    </li>
                     <li class="selected">
                            <a href="{{route('branch.getbranchdriverrequest')}}">
                            <div class="icon-w">
                                <div class="os-icon-grid-circles"></div>
                            </div><span>Drivers Request</span></a>
                    ...
                    <li class="selected">
                        <a href="{{route('business.staffrequests')}}">
                            <div class="icon-w">
                               <div class="os-icon os-icon-layout"></div>
                            </div><span>Trip Request</span></a>
                    </li>

                     <li class="selected">
                        <a href="{{route('business.indstafftrips')}}">
                            <div class="icon-w">
                               <div class="os-icon os-icon-layout"></div>
                            </div><span>My Trip</span></a>
                    </li>
                    @endif
            ...
            <div class="menu-w color-scheme-light color-style-transparent menu-position-side menu-side-left menu-layout-compact sub-menu-style-over sub-menu-color-bright selected-menu-color-light menu-activated-on-hover menu-has-selected-link">
               <div class="logo-w">
				...
				<ul class="main-menu">
                    ...
                    <li class="selected ">
                        <a href="{{route('business.tripswithbranch')}}">
                            <div class="icon-w">
                                <div class="picons-thin-icon-thin-0545_map_travel_distance_directions"></div>
                            </div><span>Trips + branch </span></a>
                    </li>
                    <li class="selected ">
                        <a href="{{route('trip.alltrips')}}">
                            <div class="icon-w">
                     ...
                     <li class="selected ">
                        <a href="{{route('branch.index')}}">
                            <div class="icon-w">
                                <div class="os-icon os-icon-mail-01"></div>
                            </div><span>Add Branch</span></a>
                    </li>
                    @endif
