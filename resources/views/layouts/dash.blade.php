...
<!--
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/3.0.1/css/font-awesome-ie7.min.css" integrity="sha512-bDwTcMEoUsVnKAxV7BkdkTXNiQd4DfNqeI4dThwL8HfKnsbOvt6E1Z8b6JGUeQTaKKgUN+XCxNGsLixyNaatrA==" crossorigin="anonymous" />
    !-->
</head>
            ...
            <div class="menu-w color-scheme-light color-style-transparent menu-position-side menu-side-left menu-layout-compact sub-menu-style-over sub-menu-color-bright selected-menu-color-light menu-activated-on-hover menu-has-selected-link">
               <div class="logo-w">
				...
				<ul class="main-menu">
					...
					<li class=" ">
                        <a href="{{route('dashboard.getallusers')}}">
                            <div class="icon-w">
                                <div class="picons-thin-icon-thin-0719_group_users_circle"></div>
                            </div><span>Staff</span></a>
                    </li>
                    <li class=" ">
                        <a href="{{route('dashboard.getallbusinessaccount')}}">
                            <div class="icon-w">
                                <div class="picons-thin-icon-thin-0496_car_garage_house_home"></div>
                            </div><span>Business Account</span></a>
                    </li>
					  @if(Auth::user()->userType == 'admin')<li class=" ">
                        <a href="{{route('driver.index')}}">
                            <div class="icon-w">
                                <div class="picons-thin-icon-thin-0468_car_transport_vehicle"></div>
                            </div><span>Drivers</span></a>
                            <a href="{{route('trackertrip.index')}}">
                            <div class="icon-w">
                                <div class="xpicons-thin-icon-thin-0468_car_transport_vehicle"></div>
                            </div><span>Tracker Trips</span></a>
                    </li> @endif
			<!--		<li class=" ">
                        <a href="map.html">
                            <div class="icon-w">
                                <div class="picons-thin-icon-thin-0546_map_travel_destination_location_world"></div>
                            </div><span>Map</span></a>
                    </li> -->
					<li class=" ">
                        <a href="{{route('dashboard.getallcompletedtrips')}}">
                            <div class="icon-w">
                  ...
                  @if(Auth::user()->userType == 'admin')  <li class=" ">
                        <a href="{{route('config.index')}}">
                            <div class="icon-w">
                                <div class="os-icon os-icon-file-text"></div>
                            </div><span>Payment Settings</span></a>
                    </li> @endif
                    <li class=" ">
                        <a href="{{route('driver.listdriverwithamountcount')}}">
                            <div class="icon-w">
                                <div class="os-icon os-icon-user-male-circle"></div>
                            </div><span>Drivers Report</span></a>
                    </li> 
                    
                    <li class=" ">
                    
                        <a href="{{route('dashboard.uploadlist')}}">
                            <div class="icon-w">
                                <div class="os-icon os-icon-user-male-circle"></div>
                            </div><span>Upload files</span></a>
                    </li> 
                    ...
                    <li class=" ">
                        <a href="{{route('audit.index')}}">
                            <div class="icon-w">
                                <div class="os-icon os-icon-user-male-circle"></div>
                            </div><span>Audit Trails</span></a>
                    </li> 
                   
					 <li class="sub-header"><span>Technical</span></li>
                    <li class="selected ">
                        <a href="{{route('appsetting.index')}}">
                            <div class="icon-w">
                               <div class="os-icon os-icon-layout"></div>
                            </div><span>App Settings</span></a>
                    </li>
                     ...
                     <li class="selected ">
                        <a href="{{route('region.index')}}">
                            <div class="icon-w">
                               <div class="os-icon os-icon-layout"></div>
                            </div><span>Region Settings</span></a>
                    </li>
                     <li class="selected ">
                        <a href="{{route('platenumber.index')}}">
                            <div class="icon-w">
                               <div class="os-icon os-icon-layout"></div>
                            </div><span>Driver's PlateNumber Settings</span></a>
                    </li>
					<!--<li class="selected ">
