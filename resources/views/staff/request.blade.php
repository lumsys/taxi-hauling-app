...
<div class="element-wrapper">
                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-4">
                               <div class="element-box">
                                <h5 class="form-header">Request Trip</h5> 
								<form action="{{route('user.stafftriprequest')}}" method="POST" enctype="multipart/form-data" >
									{{ csrf_field() }}
                ...
                <!--                   <input type="text" name="name" class="form-control" data-error="" placeholder="Fullname" required="required" ><br>
									...
									<input type ="file" name="profileUrl" class="form-control"  placeholder="image" ><br> -->
												...
												<center><button class="btn btn-sm btn-primary" name="submit">Make Request</button></center>
                                    </div>
								</form>
                            </div>
                             </div>
							 <div class="element-box col-lg-8">
                                      ...
                                      @foreach($requests as $request)
                                                    <tr>
                                                        <td>
                                                            <div class="user-with-avatar"><span class="d-none d-xl-inline-block">{{$request->tripRequest}}</span></div>
                                                        </td>
                                                        <td class="text-center">{{$request->created_at}}</td>
                                                      <!--  <td class="text-center">c</td>
                                                        <td class="text-right"><a class="btn btn-sm btn-danger" href="#">Delete</a></td> -->
                                                    </tr>
                                      @endforeach
